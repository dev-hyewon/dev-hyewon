...
![MCP](https://img.shields.io/badge/MCP-FFA500?style=for-the-badge&logo=modelcontextprotocol&logoColor=white)
...
>
> - LLM 연동 백엔드 아키텍처 설계
> - 실시간 데이터 기반 AI 서비스 개발
> - MCP(Model Context Protocol) 활용 시스템 구축
> - LangGraph 기반 AI Workflow 설계
> - AI 모델 서빙 및 운영 환경 최적화
